class ResponseRepoList {
  int? totalCount;
  bool? incompleteResults;
  List<Items>? items;

  ResponseRepoList({this.totalCount,incompleteResults,items});

  ResponseRepoList.fromJson(Map<String, dynamic> json) {
...
class License {
  ...
  License({this.key,name,spdxId,url,nodeId});
